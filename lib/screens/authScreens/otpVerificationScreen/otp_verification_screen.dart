...
class OtpVerificationScreen extends StatefulWidget {
  ...
  const OtpVerificationScreen({super.key,  required this.phNumber, required this.type});
          ...
          children: [
            ...
            CustomButton(
              child: Poppins(
                ...
                onPressed: () => widget.type=='Student'?Get.offAll(StudentDashboard(index: 0)):widget.type=='Tutor'?Get.offAll(TutorDashboard()):SizedBox(),
          ...
          Stack(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Image.asset(Images.smalllogo, height: 90,color: Get.theme.secondaryHeaderColor,),
