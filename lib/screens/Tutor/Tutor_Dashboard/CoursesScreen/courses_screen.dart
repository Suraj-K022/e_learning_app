...
class _CoursesScreenState extends State<CoursesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        actions: [
          InkWell(onTap: (){Get.to(AddCourseNameScreen());},child: Icon(CupertinoIcons.plus_app,color: Get.theme.primaryColor,size: 24,)),SizedBox(width: 24,)],
        centerTitle: true,
      ...
      body: GetBuilder<CourseController>(builder: (courseController) {
        return RefreshIndicator(color: Get.theme.scaffoldBackgroundColor,backgroundColor: Get.theme.primaryColor,
          onRefresh: () async {
                          ...
                          Row(
                            children: [
                              SizedBox(
                                height: 50,
                                width: 50,
                                child: Image.network(course.courseImage.toString()),
                              ),
                              SizedBox(width: 8),
                              Column(
                                ...
                                children: [
                                  ...
                                  Poppins(
                                    text: '${course.totalContent} lectures',
                                    fontWeight: FontWeight.w400,
