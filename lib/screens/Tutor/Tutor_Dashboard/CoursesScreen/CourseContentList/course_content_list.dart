      ...
      return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            InkWell(
              onTap: () {
                Get.to(() => CreateNewCourse(courseName:widget.appbarTitle, ScreenName: 'CourseContentScreen'));
              },
              child: Icon(CupertinoIcons.plus_app, color: Get.theme.primaryColor),
            ),
            const SizedBox(width: 24),
          ],
        ),
        body: (courseController.allContentList == null || courseController.allContentList!.isEmpty)
            ? Center(
          child: Poppins(
            ...
            : RefreshIndicator(color: Get.theme.scaffoldBackgroundColor,backgroundColor: Get.theme.primaryColor,
          onRefresh: () async {
                ...
                child: ListTile(
                  ...
                  trailing: InkWell(
                    onTap: () async {
                      ...
                      await Get.find<CourseController>().deleteContent(
                        courseController.allContentList![index].id!, // <- assert non-null
                      ).then((response) {
                    ...
                    child: Icon(CupertinoIcons.delete, size: 20, color: Colors.red),
                  ),
